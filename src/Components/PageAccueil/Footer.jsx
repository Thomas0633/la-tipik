    ...
    render() {
      return (
            ...
            <Container fluid className="text-center text-md-left">
                <Row>
                    <Col md="2">
                        <Link to="/"><img src="/image/LogoLaTipik.png"  className="LogoLaTipik" alt="logo"/></Link>
                    </Col>
                    ...
                    <Col md="2">
                        ...
                        <li>
                            <Link className="rubriques" to="/apropos/">A propos</Link>
                        </li>
                        <li>
                            <Link className="rubriques" to="/Comment/">Aide</Link>
                        </li>
                        <li>
                            <Link className="rubriques" to="/formulaireContact/">Contact</Link>
                        </li>
                        </ul>
                    </Col>
                    <hr className="clearfix w-100 d-md-none" />
                    <Col md="2">
                        ...
                        <li>
                            <Link className="rubriques" to="/catalogue">Réserver en ligne</Link>
                        </li>
                        <li>
                    ...
                    <Col md="4" className="d-flex justify-content-center">
                        ...
                        <NavItem>
                            ...
                            <img src="/image/Facebook.png" className="Facebook" alt="fb"/>
                            </NavLink>
                        </NavItem>
                        <NavItem>
                            <NavLink href="https://www.instagram.com" className="btn-floating btn-sm btn-tw mx-1">
                            <img src="/image/Instagram.png" className="Instagram" alt="Insta"/>
                            </NavLink>
                        </NavItem>
                        <NavItem>
                            <NavLink href="https://twitter.com" className="btn-floating btn-sm btn-li mx-1">
                            <img src="/image/Twitter.png" className="Twitter" alt="Tw"/>
                            </NavLink>
                        </NavItem>
                        </Nav>
                    </Col>
